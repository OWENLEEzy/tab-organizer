export const ACCENT_KEYS = ['clay', 'sage', 'frost', 'ochre', 'lavender', 'rosewood', 'seagrass', 'obsidian', 'pine', 'amethyst'] as const;
...
export const ACCENTS: Record<AccentKey, AccentConfig> = {
  ...
  rosewood: {
    ...
    textMuted: '#B09698',
    accentPrimary: '#A0676B',
    accentPrimaryRgb: '160, 103, 107',
  ...
  seagrass: {
    ...
    textMuted: '#98ADA6',
    accentPrimary: '#5B8A7E',
    accentPrimaryRgb: '91, 138, 126',
