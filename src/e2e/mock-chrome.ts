...
export const mockChromeApi = (scenario: E2EScenario = 'default') => {
  ...
  const mockTabs: chrome.tabs.Tab[] = [
    { id: 1, url: 'https://github.com/explore', title: 'Explore · GitHub', favIconUrl: 'https://github.githubassets.com/favicons/favicon.png', windowId: 1, active: true, index: 0, pinned: false, highlighted: false, incognito: false, selected: false, status: 'complete', frozen: false, discarded: false, autoDiscardable: true, groupId: -1, lastAccessed: 1_700_000_000_000 },
