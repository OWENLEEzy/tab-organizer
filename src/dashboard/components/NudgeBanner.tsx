  ...
  return (
    ...
    >
      <div className="flex items-center gap-4">
        <div className="bg-accent-red/10 flex size-9 shrink-0 items-center justify-center rounded-full">
          <svg
      ...
      <button
        type="button"
        onClick={onDismiss}
        className="rounded-chip text-text-secondary hover:bg-accent-red/10 hover:text-accent-red focus-visible:ring-accent-primary/40 ml-4 flex size-[var(--spacing-button-icon)] shrink-0 cursor-pointer items-center justify-center transition-colors focus-visible:ring-2 focus-visible:outline-none"
