...
import { buildHistorySnapshot, shouldReplaceHistoryCandidate } from '../lib/recovery-snapshots';
  ...
  it('excludes browser internal and Tab Organizer pages and keeps product summaries', () => {
    const snapshot = buildHistorySnapshot(
      [
        ...
        makeTab({ id: 4, url: 'chrome-extension://fake-id/src/dashboard/index.html', title: 'Tab Organizer' }),
      ],
      '2026-05-05T00:00:00.000Z',
    );
